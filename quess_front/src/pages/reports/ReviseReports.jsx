...
const ReviseReports = () => {
  ...
  useEffect(() => {
    if (selectedOrgId) {
      dispatch(getPendingAirReports(selectedOrgId));
      dispatch(getPendingSurfaceReports(selectedOrgId));
    }
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Box display="flex" justifyContent="left">
          ...
          <AddRecommendations Data={params.row} />
        </Box>
      ),
    },
  ];
  ...
  return (
    <Box m="20px">
      ...
      <Header
        title="Revise Reports"
        subtitle="Revise reports and add recommendations"
      />
      <Box
        m="40px 0 0 0"
        height="75vh"
