 ...
 */
final class Version20240528093545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE air_sampler_settings ADD organization_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE air_sampler_settings DROP organization_id');
    }
}
